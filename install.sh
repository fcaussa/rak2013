...
[ -z ${1+z} ] && echo "APN is set to $1" || echo "APN Not defined" && exit 1;
[ -z ${2+z} ] && echo "Serial Port is set to $2" || echo "Serial Port Not defined" && exit 1;
[ -z ${3+z} ] && echo "Baudrate is set to $3" || echo "Modem Baudrate Not defined" && exit 1;
[ -z ${4+z} ] && echo "Pin5 is set to $4" || echo "Pin5 Not defined" && exit 1;
[ -z ${5+z} ] && echo "Pin6 is set to $5" || echo "Pin6 Not defined" && exit 1;
[ -z ${6+z} ] && echo "Pin13 is set to $6" || echo "Pin13 Not defined" && exit 1;
[ -z ${7+z} ] && echo "Pin18 is set to $7" || echo "Pin18 Not defined" && exit 1;
[ -z ${8+z} ] && echo "Pin19 is set to $8" || echo "Pin19 Not defined" && exit 1;
[ -z ${9+z} ] && echo "Pin21 is set to $9" || echo "Pin21 Not defined" && exit 1;
[ -z ${10+z} ] && echo "Pin26 is set to ${10}" || echo "Pin26 Not defined" && exit 1;
